...
// Scintillator Wrapper
  G4Tubs* Scint_Wrap = new G4Tubs("Scint_Wrap",25.5*mm, 25.6*mm,35.75*mm,0*deg,360*deg);
...
//
  ...
  opWrapSurface->SetType(dielectric_dielectric);
  opWrapSurface->SetFinish(polished);
  opWrapSurface->SetModel(unified);
